...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "MarkedSubject$ebnf$1$subexpression$1", "symbols": [{"literal":"en"}, "Phrase"], "postprocess": ([marker, subject]) => ({ type: "subject", marker, phrase: subject })},
    {"name": "MarkedSubject$ebnf$1", "symbols": ["MarkedSubject$ebnf$1$subexpression$1"]},
    {"name": "MarkedSubject$ebnf$1$subexpression$2", "symbols": [{"literal":"en"}, "Phrase"], "postprocess": ([marker, subject]) => ({ type: "subject", marker, phrase: subject })},
    ...
    {"name": "MarkedSubject$ebnf$2$subexpression$1", "symbols": [{"literal":"anu"}, "Phrase"], "postprocess": ([marker, subject]) => ({ type: "subject", marker, phrase: subject })},
    {"name": "MarkedSubject$ebnf$2", "symbols": ["MarkedSubject$ebnf$2$subexpression$1"]},
    {"name": "MarkedSubject$ebnf$2$subexpression$2", "symbols": [{"literal":"anu"}, "Phrase"], "postprocess": ([marker, subject]) => ({ type: "subject", marker, phrase: subject })},
    {"name": "MarkedSubject$ebnf$2", "symbols": ["MarkedSubject$ebnf$2", "MarkedSubject$ebnf$2$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "MarkedSubject", "symbols": ["Phrase", "MarkedSubject$ebnf$2"], "postprocess": ([subject, subjects]) => [{ type: "subject", phrase: subject }, ...subjects]},
    ...
    {"name": "Predicates$ebnf$2", "symbols": []},
    {"name": "Predicates$ebnf$2$subexpression$1", "symbols": [{"literal":"anu"}, "Predicate"], "postprocess": ([li, predicate]) => ({ marker: li, ...predicate })},
    {"name": "Predicates$ebnf$2", "symbols": ["Predicates$ebnf$2", "Predicates$ebnf$2$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Predicates", "symbols": ["Predicate", "Predicates$ebnf$2"], "postprocess": ([predicate, predicates]) => [predicate, ...predicates]},
